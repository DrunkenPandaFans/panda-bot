...
class MessageSpecs extends Specification {
  ...
  "Message" should {
    "parse private message" in {
      ...
      val expected = PrivateMessage("panda", "This is awesome message")
    ...
    "print private message" in {
      ...
      val message = Response("toMe", "This is awesome")
    ...
    "not print anything else" in {
      val message = Ping("abcds")
      Message.print(message) must beEqualTo("")
      Message.print(Unknown) must beEqualTo("")
      Message.print(PrivateMessage("to", "private message")) must beEqualTo("")
    }
  }
}
